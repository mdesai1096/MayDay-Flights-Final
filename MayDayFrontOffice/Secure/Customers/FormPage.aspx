...
<p style="font-size: large">
    ...
    <span class="auto-style7"><strong>&nbsp;&nbsp; </strong> 
...
<p style="font-size: large">
    ...
    <asp:Button ID="btnBacktoCustomerHomePage" runat="server" OnClick="btnBacktoCustomerHomePage_Click" style="position: absolute; top: 280px; left: 976px; width: 200px; height: 40px; z-index: 1;" Text="Back to Customer Home Page" />
    <asp:Button ID="btnBackToAdminHomePage" runat="server" OnClick="btnBackToAdminHomePage_Click" Text="Back to Admin Home Page" style="margin-left: 0px; margin-bottom: 0px; position: absolute; top: 338px; left: 974px; width: 200px; height: 40px; margin-top: 0px;" />
    </strong>
</p>
<p style="font-size: large">
    <strong>
    ...
    <asp:TextBox ID="txtPostCode" runat="server" Width="122px" CssClass="auto-style7"></asp:TextBox>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </strong>
    <asp:Label ID="lblError" runat="server" style="z-index: 1; left: 760px; top: 466px; position: absolute; width: 798px; font-size: large; bottom: 154px; margin-bottom: 0px;"></asp:Label>
    <strong>
    <asp:Button ID="btnBacktoLoginPage" runat="server" OnClick="btnBacktoLoginPage_Click" style="text-align: center; position: absolute; top: 396px; left: 974px; width: 200px; margin-top: 0px; height: 40px; z-index: 1;" Text="Back to Login Page " />
    </strong>
</p>
<p style="font-size: large">
    <strong>
...
<p style="font-size: large">
    ...
    </strong><span class="auto-style7"><strong>&nbsp;</strong></span><strong><asp:TextBox ID="txtContactNumber" runat="server" Width="161px" CssClass="auto-style7" Height="16px"></asp:TextBox>
    </strong>
</p>
<p style="font-size: large">
    <strong>
    ...
    <asp:TextBox ID="txtEmail" runat="server" Width="226px" CssClass="auto-style7" Height="16px"></asp:TextBox>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnEnter" runat="server" Height="39px" OnClick="btnEnter_Click" Text="Enter" Width="176px" style="z-index: 1; left: 690px; top: 558px; position: absolute" />
    </strong>
</p>
    <p style="font-size: large">
&nbsp;</p>
