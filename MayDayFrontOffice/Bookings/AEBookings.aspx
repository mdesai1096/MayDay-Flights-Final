...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TextBox ID="TextBox7" runat="server" style="z-index: 1; left: 1418px; top: 537px; position: absolute"></asp:TextBox>
    <br />
    <br />
    <asp:Button ID="btnOK" runat="server" style="z-index: 1; left: 511px; top: 541px; position: absolute; margin-bottom: 0px" Text="OK" />
