...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="btnNew" runat="server" style="z-index: 1; left: 419px; top: 572px; position: absolute" Text="New Booking" />
    <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 1397px; top: 575px; position: absolute" Text="Cancel Booking" />
    <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 947px; top: 571px; position: absolute" Text="Update Booking" />
